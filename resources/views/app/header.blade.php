...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> gift2gives.thailand@gmail.com</li>
...
@yield('content')
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  Build v{{ Illuminate\Foundation\Application::VERSION }}
